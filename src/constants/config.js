...
export const currentUser = {
  id: 1,
  title: localStorage.getItem('bridgeAfrica-user') !== null && localStorage.getItem('bridgeAfrica-user').length > 0 ? JSON.parse(localStorage.getItem('bridgeAfrica-user')).fullname : 'User : Bridge Africa',
