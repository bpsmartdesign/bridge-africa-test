<template>
  <nav class="navbar fixed-top">
    ...
    <router-link class="navbar-logo d-flex align-items-center" tag="a" to="/">
      <img :src="require('../../assets/logos/logo.png')" width="40px" />
      <span class="ml-2">BRIDGE_AFRICA</span>
    </router-link>
...
export default {
  ...
  methods: {
    ...
    logout() {
      localStorage.removeItem('bridgeAfrica-user')
